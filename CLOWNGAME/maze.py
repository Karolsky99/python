...
mixer.music.load('horror music.mp3')
...
redColor = pygame.Color(215,15,15)
greenColor = pygame.Color(255,204,0)
...
while ison:
	...
	fpsClock.tick(fps)
while not ison:
	im = Image.open(r"C:\Users\User\PycharmProjects\PythonHubIG\clown2.png")
	im.show()
	mixer.music.stop()
	mixer.music.load('clown.wav')
